#Decompiled by WAHID ID
#Modified By WAHID ID
#JANGAN LUPA SUBREG BANGSAD
#https://youtube.com/channel/UCMimqBymJHm5Ga3sD3iOQ_w
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK LU TOD BGST KAO KYMAK! \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/UCMimqBymJHm5Ga3sD3iOQ_w')
                time.sleep(2)
                menu()
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun lu kena Checkpoint KAMBINK'
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mAkun lu kena Checkpoint KAMBINK'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
    ...
    print '\x1b[1;31;40m0. Keluar Dari Tools Ini '
    print
    pilih()
...
def bot_komen():
    ...
    try:
        ...
        try:
            ...
            a = json.loads(p.text)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar COKK  \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
...
def grup_komen():
    ...
    try:
        ...
        print '\x1b[1;91m[!] Token tidak ditemukan PUKY MAY'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    else:
